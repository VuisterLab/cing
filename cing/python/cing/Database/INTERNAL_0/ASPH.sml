...
#=======================================================================
#             	internal short   
<ResidueDef>  	ASPH     D        INTERNAL_0
#=======================================================================
	comment    = 'protonated (neutral) ASP (uncommon)'
	nameDict   = {'CCPN': 'protein Asp prot:HD2', 'INTERNAL_0': 'ASPH', 'IUPAC': 'ASP', 'AQUA': 'ASP', 'BMRBd': 'ASP', 'INTERNAL_1': 'ASPH', 'CYANA': 'ASP', 'CYANA2': None, 'PDB': 'ASP', 'XPLOR': None}
	properties = ['protein', 'aliphatic', 'charged']
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CG'), (0, 'HD2')]
		nameDict   = {'CCPN': 'OD2', 'INTERNAL_0': 'OD2', 'IUPAC': 'OD2', 'AQUA': 'OD2', 'BMRBd': 'OD2', 'INTERNAL_1': 'OD2', 'CYANA': 'OD2', 'CYANA2': 'OD2', 'PDB': 'OD2', 'XPLOR': 'OD2'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'O_HYD'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'OD2')]
		nameDict   = {'CCPN': 'HD2', 'INTERNAL_0': 'HD2', 'IUPAC': 'HD2', 'AQUA': 'HD2', 'BMRBd': 'HD2', 'INTERNAL_1': 'HD2', 'CYANA': 'HD2', 'CYANA2': 'HD2', 'PDB': None, 'XPLOR': None}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'H_OXY'
