...
#=======================================================================
#             	internal short   
<ResidueDef>  	ARG      R        INTERNAL_0
#=======================================================================
	comment    = 'Protonated (plus) ARG (common)'
	nameDict   = {'CCPN': 'protein Arg prot:HH12', 'INTERNAL_0': 'ARG', 'IUPAC': 'ARG', 'AQUA': 'ARG', 'BMRBd': 'ARG', 'INTERNAL_1': 'ARG', 'CYANA': 'ARG+', 'CYANA2': 'ARG', 'PDB': 'ARG', 'XPLOR': 'ARG'}
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NH1')]
		nameDict   = {'CCPN': 'HH11', 'INTERNAL_0': 'HH11', 'IUPAC': 'HH11', 'AQUA': 'HH11', 'BMRBd': 'HH11', 'INTERNAL_1': 'HH11', 'CYANA': 'HH11', 'CYANA2': 'HH11', 'PDB': '1HH1', 'XPLOR': 'HH11'}
		aliases    = []
		pseudo     = 'QH1'
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NH1')]
		nameDict   = {'CCPN': 'HH12', 'INTERNAL_0': 'HH12', 'IUPAC': 'HH12', 'AQUA': 'HH12', 'BMRBd': 'HH12', 'INTERNAL_1': 'HH12', 'CYANA': 'HH12', 'CYANA2': 'HH12', 'PDB': '2HH1', 'XPLOR': 'HH12'}
		aliases    = []
		pseudo     = 'QH1'
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NH1')]
		nameDict   = {'CCPN': 'HH1*', 'INTERNAL_0': 'QH1', 'IUPAC': 'QH1', 'AQUA': 'QH1', 'BMRBd': None, 'INTERNAL_1': 'QH1', 'CYANA': 'QH1', 'CYANA2': 'QH1', 'PDB': None, 'XPLOR': 'HH1*,HH1#,HH1%,HH1+'}
		aliases    = []
		pseudo     = None
		real       = ['HH11', 'HH12']
		type       = 'PSEUD'
