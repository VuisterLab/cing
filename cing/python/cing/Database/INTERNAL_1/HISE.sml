...
#=======================================================================
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'N', 'BMRBd': None, 'IUPAC': 'N', 'AQUA': 'N', 'INTERNAL_0': 'N', 'INTERNAL_1': 'N', 'CYANA': 'N', 'CYANA2': 'N', 'PDB': None, 'XPLOR': 'N'}
		aliases    = []
		type       = 'N_AMI'
		spinType   = '15N'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'CA', 'BMRBd': None, 'IUPAC': 'CA', 'AQUA': 'CA', 'INTERNAL_0': 'CA', 'INTERNAL_1': 'CA', 'CYANA': 'CA', 'CYANA2': 'CA', 'PDB': None, 'XPLOR': 'CA'}
		aliases    = []
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'HA', 'BMRBd': None, 'IUPAC': 'HA', 'AQUA': 'HA', 'INTERNAL_0': 'HA', 'INTERNAL_1': 'HA', 'CYANA': 'HA', 'CYANA2': 'HA', 'PDB': None, 'XPLOR': 'HA'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'CB', 'BMRBd': None, 'IUPAC': 'CB', 'AQUA': 'CB', 'INTERNAL_0': 'CB', 'INTERNAL_1': 'CB', 'CYANA': 'CB', 'CYANA2': 'CB', 'PDB': None, 'XPLOR': 'CB'}
		aliases    = []
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QB'
		nameDict   = {'CCPN': 'HB2', 'BMRBd': None, 'IUPAC': 'HB2', 'AQUA': 'HB2', 'INTERNAL_0': 'HB2', 'INTERNAL_1': 'HB2', 'CYANA': 'HB2', 'CYANA2': 'HB2', 'PDB': None, 'XPLOR': 'HB2'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QB'
		nameDict   = {'CCPN': 'HB3', 'BMRBd': None, 'IUPAC': 'HB3', 'AQUA': 'HB3', 'INTERNAL_0': 'HB3', 'INTERNAL_1': 'HB3', 'CYANA': 'HB3', 'CYANA2': 'HB3', 'PDB': None, 'XPLOR': 'HB1'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'CG', 'BMRBd': None, 'IUPAC': 'CG', 'AQUA': 'CG', 'INTERNAL_0': 'CG', 'INTERNAL_1': 'CG', 'CYANA': 'CG', 'CYANA2': 'CG', 'PDB': None, 'XPLOR': 'CG'}
		aliases    = []
		type       = 'C_VIN'
		spinType   = '13C'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'ND1', 'BMRBd': None, 'IUPAC': 'ND1', 'AQUA': 'ND1', 'INTERNAL_0': 'ND1', 'INTERNAL_1': 'ND1', 'CYANA': 'ND1', 'CYANA2': 'ND1', 'PDB': None, 'XPLOR': 'ND1'}
		aliases    = []
		type       = 'N_AMI'
		spinType   = '15N'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'CD2', 'BMRBd': None, 'IUPAC': 'CD2', 'AQUA': 'CD2', 'INTERNAL_0': 'CD2', 'INTERNAL_1': 'CD2', 'CYANA': 'CD2', 'CYANA2': 'CD2', 'PDB': None, 'XPLOR': 'CD2'}
		aliases    = []
		type       = 'C_ARO'
		spinType   = '13C'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'HD2', 'BMRBd': None, 'IUPAC': 'HD2', 'AQUA': 'HD2', 'INTERNAL_0': 'HD2', 'INTERNAL_1': 'HD2', 'CYANA': 'HD2', 'CYANA2': 'HD2', 'PDB': None, 'XPLOR': 'HD2'}
		aliases    = []
		type       = 'H_ARO'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'NE2', 'BMRBd': None, 'IUPAC': 'NE2', 'AQUA': 'NE2', 'INTERNAL_0': 'NE2', 'INTERNAL_1': 'NE2', 'CYANA': 'NE2', 'CYANA2': 'NE2', 'PDB': None, 'XPLOR': 'NE2'}
		aliases    = []
		type       = 'N_AMI'
		spinType   = '15N'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'CE1', 'BMRBd': None, 'IUPAC': 'CE1', 'AQUA': 'CE1', 'INTERNAL_0': 'CE1', 'INTERNAL_1': 'CE1', 'CYANA': 'CE1', 'CYANA2': 'CE1', 'PDB': None, 'XPLOR': 'CE1'}
		aliases    = []
		type       = 'C_ARO'
		spinType   = '13C'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'HE1', 'BMRBd': None, 'IUPAC': 'HE1', 'AQUA': 'HE1', 'INTERNAL_0': 'HE1', 'INTERNAL_1': 'HE1', 'CYANA': 'HE1', 'CYANA2': 'HE1', 'PDB': None, 'XPLOR': 'HE1'}
		aliases    = []
		type       = 'H_ARO'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'HE2', 'BMRBd': None, 'IUPAC': 'HE2', 'AQUA': 'HE2', 'INTERNAL_0': 'HE2', 'INTERNAL_1': 'HE2', 'CYANA': 'HE2', 'CYANA2': 'HE2', 'PDB': None, 'XPLOR': 'HE2'}
		aliases    = []
		type       = 'H_AMI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'C', 'BMRBd': None, 'IUPAC': 'C', 'AQUA': 'C', 'INTERNAL_0': 'C', 'INTERNAL_1': 'C', 'CYANA': 'C', 'CYANA2': 'C', 'PDB': None, 'XPLOR': 'C'}
		aliases    = ['C', 'CO']
		type       = 'C_BYL'
		spinType   = '13C'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'O', 'BMRBd': None, 'IUPAC': 'O', 'AQUA': 'O', 'INTERNAL_0': 'O', 'INTERNAL_1': 'O', 'CYANA': 'O', 'CYANA2': 'O', 'PDB': None, 'XPLOR': 'O'}
		aliases    = ['O', "O'"]
		type       = 'O_BYL'
		spinType   = '16O'
		shift      = None
