...
#=======================================================================
	...
	#---------------------------------------------------------------
		...
		real       = ['HG11', 'HG12', 'HG13']
		pseudo     = 'QG'
		nameDict   = {'CCPN': 'HG1*', 'BMRBd': 'HG1', 'IUPAC': 'MG1', 'AQUA': 'MG1', 'INTERNAL_0': 'QG1', 'INTERNAL_1': 'MG1', 'CYANA': 'QG1', 'CYANA2': 'QG1', 'PDB': None, 'XPLOR': 'HG1*,HG1#,HG1%,HG1+'}
		aliases    = ['MG1', 'QG1']
		type       = 'PSEUD'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = ['HG21', 'HG22', 'HG23']
		pseudo     = 'QG'
		nameDict   = {'CCPN': 'HG2*', 'BMRBd': 'HG2', 'IUPAC': 'MG2', 'AQUA': 'MG2', 'INTERNAL_0': 'QG2', 'INTERNAL_1': 'MG2', 'CYANA': 'QG2', 'CYANA2': 'QG2', 'PDB': None, 'XPLOR': 'HG2*,HG2#,HG2%,HG2+'}
		aliases    = ['MG2', 'QG2']
		type       = 'PSEUD'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MG1'
		nameDict   = {'CCPN': 'HG11', 'BMRBd': None, 'IUPAC': 'HG11', 'AQUA': 'HG11', 'INTERNAL_0': 'HG11', 'INTERNAL_1': 'HG11', 'CYANA': 'HG11', 'CYANA2': 'HG11', 'PDB': '1HG1', 'XPLOR': 'HG11'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MG1'
		nameDict   = {'CCPN': 'HG12', 'BMRBd': None, 'IUPAC': 'HG12', 'AQUA': 'HG12', 'INTERNAL_0': 'HG12', 'INTERNAL_1': 'HG12', 'CYANA': 'HG12', 'CYANA2': 'HG12', 'PDB': '2HG1', 'XPLOR': 'HG12'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MG1'
		nameDict   = {'CCPN': 'HG13', 'BMRBd': None, 'IUPAC': 'HG13', 'AQUA': 'HG13', 'INTERNAL_0': 'HG13', 'INTERNAL_1': 'HG13', 'CYANA': 'HG13', 'CYANA2': 'HG13', 'PDB': '3HG1', 'XPLOR': 'HG13'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		pseudo     = None
		nameDict   = {'CCPN': 'HG*', 'BMRBd': None, 'IUPAC': 'QG', 'AQUA': 'QG', 'INTERNAL_0': 'QQG', 'INTERNAL_1': 'QG', 'CYANA': 'QQG', 'CYANA2': 'QQG', 'PDB': None, 'XPLOR': 'HG*,HG#'}
		aliases    = ['QG', 'QQG']
		type       = 'PSEUD'
		spinType   = '1H'
