...
#=======================================================================
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'C7', 'BMRBd': None, 'IUPAC': 'C7', 'AQUA': 'C7', 'INTERNAL_0': 'C7', 'INTERNAL_1': 'C7', 'CYANA': 'C7', 'CYANA2': 'C7', 'PDB': None, 'XPLOR': 'C7'}
		aliases    = []
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'M7'
		nameDict   = {'CCPN': 'H71', 'BMRBd': None, 'IUPAC': 'H71', 'AQUA': 'H71', 'INTERNAL_0': 'H71', 'INTERNAL_1': 'H71', 'CYANA': 'H71', 'CYANA2': 'H71', 'PDB': None, 'XPLOR': 'H71'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'M7'
		nameDict   = {'CCPN': 'H72', 'BMRBd': None, 'IUPAC': 'H72', 'AQUA': 'H72', 'INTERNAL_0': 'H72', 'INTERNAL_1': 'H72', 'CYANA': 'H72', 'CYANA2': 'H72', 'PDB': None, 'XPLOR': 'H72'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'M7'
		nameDict   = {'CCPN': 'H73', 'BMRBd': None, 'IUPAC': 'H73', 'AQUA': 'H73', 'INTERNAL_0': 'H73', 'INTERNAL_1': 'H73', 'CYANA': 'H73', 'CYANA2': 'H73', 'PDB': None, 'XPLOR': 'H73'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = ['H71', 'H72', 'H73']
		pseudo     = None
		nameDict   = {'CCPN': 'H7*', 'BMRBd': None, 'IUPAC': 'M7', 'AQUA': 'M7', 'INTERNAL_0': 'Q7', 'INTERNAL_1': 'M7', 'CYANA': 'Q7', 'CYANA2': 'Q7', 'PDB': None, 'XPLOR': 'Q7'}
		aliases    = ['M7', 'Q7']
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = None
