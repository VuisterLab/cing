...
#=======================================================================
#             	internal short   
<ResidueDef>  	A        a        INTERNAL_1
#=======================================================================
	comment    = 'adenine'
	nameDict   = {'CCPN': 'RNA A deprot:H1', 'BMRBd': 'RADE', 'IUPAC': 'A', 'AQUA': 'A', 'INTERNAL_0': 'RADE', 'INTERNAL_1': 'A', 'CYANA': 'RADE', 'PDB': 'RADE', 'XPLOR': 'RADE'}
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'N6', 'BMRBd': None, 'IUPAC': 'N6', 'AQUA': 'N6', 'INTERNAL_0': 'N6', 'INTERNAL_1': 'N6', 'CYANA': 'N6', 'CYANA2': 'N6', 'PDB': None, 'XPLOR': 'N6'}
		aliases    = []
		type       = 'N_AMI'
		spinType   = '15N'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'Q6'
		nameDict   = {'CCPN': 'H61', 'BMRBd': None, 'IUPAC': 'H61', 'AQUA': 'H61', 'INTERNAL_0': 'H61', 'INTERNAL_1': 'H61', 'CYANA': 'H61', 'CYANA2': 'H61', 'PDB': None, 'XPLOR': 'H61'}
		aliases    = []
		type       = 'H_AMI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'Q6'
		nameDict   = {'CCPN': 'H62', 'BMRBd': None, 'IUPAC': 'H62', 'AQUA': 'H62', 'INTERNAL_0': 'H62', 'INTERNAL_1': 'H62', 'CYANA': 'H62', 'CYANA2': 'H62', 'PDB': None, 'XPLOR': 'H62'}
		aliases    = []
		type       = 'H_AMI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = ['H61', 'H62']
		pseudo     = None
		nameDict   = {'CCPN': 'H6*', 'BMRBd': None, 'IUPAC': 'Q6', 'AQUA': 'Q6', 'INTERNAL_0': 'Q6', 'INTERNAL_1': 'Q6', 'CYANA': 'Q6', 'CYANA2': 'Q6', 'PDB': None, 'XPLOR': 'Q6'}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = None
