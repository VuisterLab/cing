...
#=======================================================================
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'OD1', 'BMRBd': 'OD1', 'IUPAC': 'OD1', 'AQUA': 'OD1', 'INTERNAL_0': 'OD1', 'INTERNAL_1': 'OD1', 'CYANA': 'OD1', 'CYANA2': 'OD1', 'PDB': 'OD1', 'XPLOR': 'OD1'}
		aliases    = []
		type       = 'O_BYL'
		spinType   = '16O'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'OD2', 'BMRBd': 'OD2', 'IUPAC': 'OD2', 'AQUA': 'OD2', 'INTERNAL_0': 'OD2', 'INTERNAL_1': 'OD2', 'CYANA': 'OD2', 'CYANA2': 'OD2', 'PDB': 'OD2', 'XPLOR': 'OD2'}
		aliases    = []
		type       = 'O_BYL'
		spinType   = '16O'
		shift      = None
