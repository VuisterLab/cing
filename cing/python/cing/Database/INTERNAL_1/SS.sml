...
#=======================================================================
#             	internal short   
<ResidueDef>  	SS       s        INTERNAL_1
#=======================================================================
	comment    = 'generic residue used by xeasy'
	nameDict   = {'BMRBd': None, 'IUPAC': None, 'AQUA': None, 'INTERNAL_0': 'SS', 'INTERNAL_1': 'SS', 'CYANA': 'SS', 'CYANA2': 'SS', 'PDB': None, 'XPLOR': None}
	properties = ['protein']
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'BMRBd': 'H', 'IUPAC': 'H', 'AQUA': 'H', 'INTERNAL_0': 'HN', 'INTERNAL_1': 'H', 'CYANA': 'HN', 'CYANA2': 'H', 'PDB': 'H', 'XPLOR': 'HN'}
		aliases    = ['HN', 'H']
		type       = 'H_AMI'
		spinType   = '1H'
		shift      = None
