...
#=======================================================================
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'OH', 'BMRBd': 'OH', 'IUPAC': 'OH', 'AQUA': 'OH', 'INTERNAL_0': 'OH', 'INTERNAL_1': 'OH', 'CYANA': 'OH', 'CYANA2': 'OH', 'PDB': 'OH', 'XPLOR': 'OH'}
		aliases    = []
		type       = 'O_HYD'
		spinType   = '16O'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'HH', 'BMRBd': 'HH', 'IUPAC': 'HH', 'AQUA': 'HH', 'INTERNAL_0': 'HH', 'INTERNAL_1': 'HH', 'CYANA': 'HH', 'CYANA2': 'HH', 'PDB': 'HH', 'XPLOR': 'HH'}
		aliases    = []
		type       = 'H_OXY'
		spinType   = '1H'
