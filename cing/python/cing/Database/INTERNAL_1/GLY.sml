...
#=======================================================================
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QA'
		nameDict   = {'CCPN': 'HA2', 'INTERNAL_0': 'HA1', 'CYANA': 'HA1', 'CYANA2': 'HA2', 'INTERNAL_1': 'HA2', 'IUPAC': 'HA2', 'AQUA': 'HA2', 'BMRBd': 'HA2', 'XPLOR': 'HA2', 'PDB': '1HA'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QA'
		nameDict   = {'CCPN': 'HA3', 'INTERNAL_0': 'HA2', 'CYANA': 'HA2', 'CYANA2': 'HA3', 'INTERNAL_1': 'HA3', 'IUPAC': 'HA3', 'AQUA': 'HA3', 'BMRBd': 'HA3', 'XPLOR': 'HA1', 'PDB': '2HA'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = ['HA2', 'HA3']
		pseudo     = None
		nameDict   = {'CCPN': 'HA*', 'INTERNAL_0': 'QA', 'CYANA': 'QA', 'CYANA2': 'QA', 'INTERNAL_1': 'QA', 'IUPAC': 'QA', 'AQUA': 'QA', 'BMRBd': None, 'XPLOR': 'HA*,HA#,HA%,HA+', 'PDB': None}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '1H'
