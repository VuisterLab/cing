...
#=======================================================================
#             	internal short   
<ResidueDef>  	LGLY     LGLY     INTERNAL_1
#=======================================================================
	comment    = 'L-glycine'
	nameDict   = {'BMRBd': None, 'IUPAC': None, 'AQUA': None, 'INTERNAL_0': 'LGLY', 'INTERNAL_1': 'LGLY', 'CYANA': 'LGLY', 'CYANA2': 'LGLY', 'PDB': None, 'XPLOR': None}
	properties = ['protein']
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'BMRBd': None, 'IUPAC': None, 'AQUA': None, 'INTERNAL_0': 'Q21', 'INTERNAL_1': 'Q21', 'CYANA': 'Q21', 'CYANA2': 'Q21', 'PDB': None, 'XPLOR': None}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'BMRBd': None, 'IUPAC': None, 'AQUA': None, 'INTERNAL_0': 'Q22', 'INTERNAL_1': 'Q22', 'CYANA': 'Q22', 'CYANA2': 'Q22', 'PDB': None, 'XPLOR': None}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = None
