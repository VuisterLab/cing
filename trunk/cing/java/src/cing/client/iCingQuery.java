...
public class iCingQuery {
	...
	final Hidden action = new Hidden(Keys.FORM_ACTION);
	...
	public iCingQuery() {
		...
		String actionServerUrl = moduleBaseUrlWithPort + "/" + Keys.SERVER_URL;
		...
		formLayoutPanel.add(new Hidden(Keys.FORM_ACCESS_KEY, iCing.currentAccessKey));
		formLayoutPanel.add(new Hidden(Keys.FORM_USER_ID, iCing.currentUserId));
