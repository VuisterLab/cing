...
DEBUG: Read     3525 rows  2 cols to newMany2OneTable
...
Accepted from adit list 1835 for a total of 3525 matches
Accepted unique 3525 PDB and 3149 BMRB entries
Will write 3525 nrows and 2 ncols to newMany2OneTable.csv
"""
...
ltotal = len(pdbIdNewMany2OneList)
l2 = ltotal - l1
...
NTmessage("Accepted from adit list %s for a total of %s matches" %( l2, ltotal))
