"""
This script will use CASP-NMR files to generate CING reports, see
Scripts/validateforCASP_NMR.py
...
to it for interuption. E.g. when 22059 is the PID of "python CaspNmrCing.py 1"
...
class caspNmrCing(Lister):
    ...
    def __init__(self,
        ...
        self.data_dir_local = "dataCASP-NMR"

#        self.results_base = 'eNMRworkshop2'
        self.results_base = CASP_NMR_BASE_NAME
...
#    new_hits_entry_list = ['T0538Org', 'T0538TS001'
