...
#=======================================================================
#             	internal short   
<ResidueDef>  	NLM      NLM      INTERNAL_1
#=======================================================================
	comment    = 'Cyana pseudo residue'
	nameDict   = {'BMRBd': None, 'IUPAC': None, 'AQUA': None, 'INTERNAL_0': 'NLM', 'INTERNAL_1': 'NLM', 'CYANA': 'NLM', 'CYANA2': 'NLM', 'PDB': None, 'XPLOR': None}
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'BMRBd': None, 'IUPAC': None, 'AQUA': None, 'INTERNAL_0': 'P', 'INTERNAL_1': 'P', 'CYANA': 'P', 'CYANA2': 'P', 'PDB': None, 'XPLOR': None}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '31P'
		shift      = None
