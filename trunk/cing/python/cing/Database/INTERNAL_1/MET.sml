...
#=======================================================================
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'CCPN': 'SD', 'BMRBd': 'SD', 'IUPAC': 'SD', 'AQUA': 'SD', 'INTERNAL_0': 'SD', 'INTERNAL_1': 'SD', 'CYANA': 'SD', 'CYANA2': 'SD', 'PDB': 'SD', 'XPLOR': 'SD'}
		aliases    = []
		type       = 'S_RED'
		spinType   = '32S'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = ['HE1', 'HE2', 'HE3']
		pseudo     = None
		nameDict   = {'CCPN': 'HE*', 'BMRBd': 'HE', 'IUPAC': 'ME', 'AQUA': 'ME', 'INTERNAL_0': 'QE', 'INTERNAL_1': 'ME', 'CYANA': 'QE', 'CYANA2': 'QE', 'PDB': None, 'XPLOR': 'HE*,HE#,HE%,HE+'}
		aliases    = ['ME', 'QE']
		type       = 'PSEUD'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'ME'
		nameDict   = {'CCPN': 'HE1', 'BMRBd': None, 'IUPAC': 'HE1', 'AQUA': 'HE1', 'INTERNAL_0': 'HE1', 'INTERNAL_1': 'HE1', 'CYANA': 'HE1', 'CYANA2': 'HE1', 'PDB': '1HE', 'XPLOR': 'HE1'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'ME'
		nameDict   = {'CCPN': 'HE2', 'BMRBd': None, 'IUPAC': 'HE2', 'AQUA': 'HE2', 'INTERNAL_0': 'HE2', 'INTERNAL_1': 'HE2', 'CYANA': 'HE2', 'CYANA2': 'HE2', 'PDB': '2HE', 'XPLOR': 'HE2'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'ME'
		nameDict   = {'CCPN': 'HE3', 'BMRBd': None, 'IUPAC': 'HE3', 'AQUA': 'HE3', 'INTERNAL_0': 'HE3', 'INTERNAL_1': 'HE3', 'CYANA': 'HE3', 'CYANA2': 'HE3', 'PDB': '3HE', 'XPLOR': 'HE3'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
