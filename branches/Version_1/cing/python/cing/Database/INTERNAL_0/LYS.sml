...
#=======================================================================
#             	internal short
<ResidueDef>  	LYS      K        INTERNAL_0
#=======================================================================
	comment    = 'Protonated (plus) Lys (common)'
	nameDict   = {'CCPN': 'protein Lys prot:HZ3', 'INTERNAL_0': 'LYS', 'IUPAC': 'LYS', 'AQUA': 'LYS', 'BMRBd': 'LYS', 'INTERNAL_1': 'LYS', 'CYANA': 'LYS+', 'CYANA2': 'LYS', 'PDB': 'LYS', 'XPLOR': 'LYS'}
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'CE', 'INTERNAL_0': 'CE', 'IUPAC': 'CE', 'AQUA': 'CE', 'BMRBd': 'CE', 'INTERNAL_1': 'CE', 'CYANA': 'CE', 'CYANA2': 'CE', 'PDB': 'CE', 'XPLOR': 'CE'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'C_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CE')]
		nameDict   = {'CCPN': 'HE2', 'INTERNAL_0': 'HE2', 'IUPAC': 'HE2', 'AQUA': 'HE2', 'BMRBd': 'HE2', 'INTERNAL_1': 'HE2', 'CYANA': 'HE2', 'CYANA2': 'HE2', 'PDB': '1HE', 'XPLOR': 'HE2'}
		aliases    = []
		pseudo     = 'QE'
		real       = []
		type       = 'H_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CE')]
		nameDict   = {'CCPN': 'HE3', 'INTERNAL_0': 'HE3', 'IUPAC': 'HE3', 'AQUA': 'HE3', 'BMRBd': 'HE3', 'INTERNAL_1': 'HE3', 'CYANA': 'HE3', 'CYANA2': 'HE3', 'PDB': '2HE', 'XPLOR': 'HE1'}
		aliases    = []
		pseudo     = 'QE'
		real       = []
		type       = 'H_ALI'
	...
	<AtomDef> NZ
	#---------------------------------------------------------------
		topology   = [(0, 'CE'), (0, 'HZ1'), (0, 'HZ2'), (0, 'HZ3')]
		nameDict   = {'CCPN': 'NZ', 'INTERNAL_0': 'NZ', 'IUPAC': 'NZ', 'AQUA': 'NZ', 'BMRBd': 'NZ', 'INTERNAL_1': 'NZ', 'CYANA': 'NZ', 'CYANA2': 'NZ', 'PDB': 'NZ', 'XPLOR': 'NZ'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'N_AMO'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NZ')]
		nameDict   = {'CCPN': 'HZ1', 'INTERNAL_0': 'HZ1', 'IUPAC': 'HZ1', 'AQUA': 'HZ1', 'BMRBd': 'HZ1', 'INTERNAL_1': 'HZ1', 'CYANA': 'HZ1', 'CYANA2': 'HZ1', 'PDB': '1HZ', 'XPLOR': 'HZ1'}
		aliases    = []
		pseudo     = 'QZ'
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NZ')]
		nameDict   = {'CCPN': 'HZ2', 'INTERNAL_0': 'HZ2', 'IUPAC': 'HZ2', 'AQUA': 'HZ2', 'BMRBd': 'HZ2', 'INTERNAL_1': 'HZ2', 'CYANA': 'HZ2', 'CYANA2': 'HZ2', 'PDB': '2HZ', 'XPLOR': 'HZ2'}
		aliases    = []
		pseudo     = 'QZ'
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NZ')]
		nameDict   = {'CCPN': 'HZ3', 'INTERNAL_0': 'HZ3', 'IUPAC': 'HZ3', 'AQUA': 'HZ3', 'BMRBd': 'HZ3', 'INTERNAL_1': 'HZ3', 'CYANA': 'HZ3', 'CYANA2': 'HZ3', 'PDB': '3HZ', 'XPLOR': 'HZ3'}
		aliases    = []
		pseudo     = 'QZ'
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NZ')]
		nameDict   = {'CCPN': 'HZ*', 'INTERNAL_0': 'QZ', 'IUPAC': 'QZ', 'AQUA': 'QZ', 'BMRBd': None, 'INTERNAL_1': 'QZ', 'CYANA': 'QZ', 'CYANA2': 'QZ', 'PDB': None, 'XPLOR': 'HZ*,HZ#,HZ%,HZ+'}
		aliases    = []
		pseudo     = None
		real       = ['HZ1', 'HZ2', 'HZ3']
		type       = 'PSEUD'
