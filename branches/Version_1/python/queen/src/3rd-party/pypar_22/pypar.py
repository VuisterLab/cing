...
try:
  ...
  errmsg = 'ERROR: compiled C extension mpiext.c not accessible:\n'
  errmsg += 'Please compile it either by running\n'
...
if sys.platform in ['linux2', 'sunos5', 'win32']:
