...
#=======================================================================
#             	internal short
<ResidueDef>  	HISE     H        INTERNAL_0
#=======================================================================
	comment    = 'protonated HE2, deprotonated HD1'
	nameDict   = {'CCPN': 'protein His prot:HE2;deprot:HD1', 'INTERNAL_0': 'HISE', 'IUPAC': 'HIS', 'AQUA': 'HIS', 'BMRBd': 'HIS', 'INTERNAL_1': 'HISE', 'CYANA': 'HIST', 'CYANA2': 'HIST', 'PDB': 'HIS', 'XPLOR': 'HIS'}
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'N', 'INTERNAL_0': 'N', 'IUPAC': 'N', 'AQUA': 'N', 'BMRBd': None, 'INTERNAL_1': 'N', 'CYANA': 'N', 'CYANA2': 'N', 'PDB': None, 'XPLOR': 'N'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'N_AMI'
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'CA', 'INTERNAL_0': 'CA', 'IUPAC': 'CA', 'AQUA': 'CA', 'BMRBd': None, 'INTERNAL_1': 'CA', 'CYANA': 'CA', 'CYANA2': 'CA', 'PDB': None, 'XPLOR': 'CA'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'C_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CA')]
		nameDict   = {'CCPN': 'HA', 'INTERNAL_0': 'HA', 'IUPAC': 'HA', 'AQUA': 'HA', 'BMRBd': None, 'INTERNAL_1': 'HA', 'CYANA': 'HA', 'CYANA2': 'HA', 'PDB': None, 'XPLOR': 'HA'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'H_ALI'
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'CB', 'INTERNAL_0': 'CB', 'IUPAC': 'CB', 'AQUA': 'CB', 'BMRBd': None, 'INTERNAL_1': 'CB', 'CYANA': 'CB', 'CYANA2': 'CB', 'PDB': None, 'XPLOR': 'CB'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'C_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CB')]
		nameDict   = {'CCPN': 'HB2', 'INTERNAL_0': 'HB2', 'IUPAC': 'HB2', 'AQUA': 'HB2', 'BMRBd': None, 'INTERNAL_1': 'HB2', 'CYANA': 'HB2', 'CYANA2': 'HB2', 'PDB': None, 'XPLOR': 'HB2'}
		aliases    = []
		pseudo     = 'QB'
		real       = []
		type       = 'H_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CB')]
		nameDict   = {'CCPN': 'HB3', 'INTERNAL_0': 'HB3', 'IUPAC': 'HB3', 'AQUA': 'HB3', 'BMRBd': None, 'INTERNAL_1': 'HB3', 'CYANA': 'HB3', 'CYANA2': 'HB3', 'PDB': None, 'XPLOR': 'HB1'}
		aliases    = []
		pseudo     = 'QB'
		real       = []
		type       = 'H_ALI'
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'CG', 'INTERNAL_0': 'CG', 'IUPAC': 'CG', 'AQUA': 'CG', 'BMRBd': None, 'INTERNAL_1': 'CG', 'CYANA': 'CG', 'CYANA2': 'CG', 'PDB': None, 'XPLOR': 'CG'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'C_VIN'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CG'), (0, 'CE1')]
		nameDict   = {'CCPN': 'ND1', 'INTERNAL_0': 'ND1', 'IUPAC': 'ND1', 'AQUA': 'ND1', 'BMRBd': None, 'INTERNAL_1': 'ND1', 'CYANA': 'ND1', 'CYANA2': 'ND1', 'PDB': None, 'XPLOR': 'ND1'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'N_AMI'
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'CD2', 'INTERNAL_0': 'CD2', 'IUPAC': 'CD2', 'AQUA': 'CD2', 'BMRBd': None, 'INTERNAL_1': 'CD2', 'CYANA': 'CD2', 'CYANA2': 'CD2', 'PDB': None, 'XPLOR': 'CD2'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'C_ARO'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CD2')]
		nameDict   = {'CCPN': 'HD2', 'INTERNAL_0': 'HD2', 'IUPAC': 'HD2', 'AQUA': 'HD2', 'BMRBd': None, 'INTERNAL_1': 'HD2', 'CYANA': 'HD2', 'CYANA2': 'HD2', 'PDB': None, 'XPLOR': 'HD2'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'H_ARO'
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'NE2', 'INTERNAL_0': 'NE2', 'IUPAC': 'NE2', 'AQUA': 'NE2', 'BMRBd': None, 'INTERNAL_1': 'NE2', 'CYANA': 'NE2', 'CYANA2': 'NE2', 'PDB': None, 'XPLOR': 'NE2'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'N_AMI'
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'CE1', 'INTERNAL_0': 'CE1', 'IUPAC': 'CE1', 'AQUA': 'CE1', 'BMRBd': None, 'INTERNAL_1': 'CE1', 'CYANA': 'CE1', 'CYANA2': 'CE1', 'PDB': None, 'XPLOR': 'CE1'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'C_ARO'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'CE1')]
		nameDict   = {'CCPN': 'HE1', 'INTERNAL_0': 'HE1', 'IUPAC': 'HE1', 'AQUA': 'HE1', 'BMRBd': None, 'INTERNAL_1': 'HE1', 'CYANA': 'HE1', 'CYANA2': 'HE1', 'PDB': None, 'XPLOR': 'HE1'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'H_ARO'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'NE2')]
		nameDict   = {'CCPN': 'HE2', 'INTERNAL_0': 'HE2', 'IUPAC': 'HE2', 'AQUA': 'HE2', 'BMRBd': None, 'INTERNAL_1': 'HE2', 'CYANA': 'HE2', 'CYANA2': 'HE2', 'PDB': None, 'XPLOR': 'HE2'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'C', 'INTERNAL_0': 'C', 'IUPAC': 'C', 'AQUA': 'C', 'BMRBd': None, 'INTERNAL_1': 'C', 'CYANA': 'C', 'CYANA2': 'C', 'PDB': None, 'XPLOR': 'C'}
		aliases    = ['C', 'CO']
		pseudo     = None
		real       = []
		type       = 'C_BYL'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'C')]
		nameDict   = {'CCPN': 'O', 'INTERNAL_0': 'O', 'IUPAC': 'O', 'AQUA': 'O', 'BMRBd': None, 'INTERNAL_1': 'O', 'CYANA': 'O', 'CYANA2': 'O', 'PDB': None, 'XPLOR': 'O'}
		aliases    = ['O', "O'"]
		pseudo     = None
		real       = []
		type       = 'O_BYL'
