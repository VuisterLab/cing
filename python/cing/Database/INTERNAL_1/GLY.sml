...
#=======================================================================
	...
	nameDict   = {'STAP': 'GLY', 'IUPAC': 'GLY', 'CYANA': 'GLY', 'PDB': 'GLY', 'XPLOR': 'GLY', 'CCPN': 'protein Gly neutral', 'BMRBd': 'GLY', 'AQUA': 'GLY', 'INTERNAL_0': 'GLY', 'INTERNAL_1': 'GLY', 'CYANA2': 'GLY'}
	...
	#---------------------------------------------------------------
		...
		type       = 'N_AMI'
		spinType   = '15N'
		shift      = NTdict( average = 109.71, sd = 4.79 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'H_AMI'
		spinType   = '1H'
		shift      = NTdict( average = 8.33, sd = 1.28 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 45.42, sd = 2.23 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QA'
		nameDict   = {'STAP': 'HA2', 'IUPAC': 'HA2', 'CYANA': 'HA1', 'PDB': '1HA', 'XPLOR': 'HA2', 'CCPN': 'HA2', 'BMRBd': 'HA2', 'AQUA': 'HA2', 'INTERNAL_0': 'HA1', 'INTERNAL_1': 'HA2', 'CYANA2': 'HA2'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QA'
		nameDict   = {'STAP': 'HA1', 'IUPAC': 'HA3', 'CYANA': 'HA2', 'PDB': '2HA', 'XPLOR': 'HA1', 'CCPN': 'HA3', 'BMRBd': 'HA3', 'AQUA': 'HA3', 'INTERNAL_0': 'HA2', 'INTERNAL_1': 'HA3', 'CYANA2': 'HA3'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = NTdict( average = 3.89, sd = 0.48 )
		hetatm     = False
		properties = ['isProton', 'proton', 'isNotCarbon', 'notcarbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isBackbone', 'backbone', 'isNotAromatic', 'notaromatic', 'isNotMethyl', 'notmethyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasPseudoAtom', 'haspseudoatom', 'isMethylene', 'methylene', 'isMethyleneProton', 'methyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		real       = ['HA2', 'HA3']
		pseudo     = None
		nameDict   = {'STAP': None, 'IUPAC': 'QA', 'CYANA': 'QA', 'PDB': None, 'XPLOR': 'HA*,HA#,HA%,HA+', 'CCPN': 'HA*', 'BMRBd': None, 'AQUA': 'QA', 'INTERNAL_0': 'QA', 'INTERNAL_1': 'QA', 'CYANA2': 'QA'}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = NTdict( average = 3.925, sd = 0.45999999999999996 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'C_BYL'
		spinType   = '13C'
		shift      = NTdict( average = 173.97, sd = 4.12 )
		hetatm     = False
		properties = ['isNotProton', 'notproton', 'isCarbon', 'carbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isBackbone', 'backbone', 'isNotAromatic', 'notaromatic', 'isNotMethyl', 'notmethyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasNoPseudoAtom', 'hasnopseudoatom', 'isNotMethylene', 'notmethylene', 'isNotMethyleneProton', 'notmethyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
