...
#=======================================================================
	...
	nameDict   = {'STAP': None, 'IUPAC': 'ASP', 'CYANA': 'ASP', 'PDB': 'ASP', 'XPLOR': 'ASP', 'CCPN': 'protein Asp prot:HD2', 'BMRBd': 'ASP', 'AQUA': 'ASP', 'INTERNAL_0': 'ASPH', 'INTERNAL_1': 'ASPH', 'CYANA2': 'ASP'}
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'STAP': None, 'IUPAC': 'HD2', 'CYANA': 'HD2', 'PDB': None, 'XPLOR': None, 'CCPN': 'HD2', 'BMRBd': 'HD2', 'AQUA': 'HD2', 'INTERNAL_0': 'HD2', 'INTERNAL_1': 'HD2', 'CYANA2': 'HD2'}
		aliases    = []
		type       = 'H_OXY'
		spinType   = '1H'
		shift      = None
