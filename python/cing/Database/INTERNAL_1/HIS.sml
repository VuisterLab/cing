...
#=======================================================================
	...
	nameDict   = {'STAP': 'HSD', 'IUPAC': 'HIS', 'CYANA': 'HIS', 'PDB': 'HIS', 'XPLOR': 'HIS', 'CCPN': 'protein His prot:HD1;deprot:HE2', 'BMRBd': 'HIS', 'AQUA': 'HIS', 'INTERNAL_0': 'HIS', 'INTERNAL_1': 'HIS', 'CYANA2': 'HIS'}
	...
	#---------------------------------------------------------------
		...
		type       = 'C_BYL'
		spinType   = '13C'
		shift      = NTdict( average = 175.17, sd = 4.51 )
		hetatm     = False
