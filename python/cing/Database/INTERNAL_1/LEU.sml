...
#=======================================================================
	...
	nameDict   = {'STAP': 'LEU', 'IUPAC': 'LEU', 'CYANA': 'LEU', 'PDB': 'LEU', 'XPLOR': 'LEU', 'CCPN': 'protein Leu neutral', 'BMRBd': 'LEU', 'AQUA': 'LEU', 'INTERNAL_0': 'LEU', 'INTERNAL_1': 'LEU', 'CYANA2': 'LEU'}
	...
	#---------------------------------------------------------------
		...
		type       = 'N_AMI'
		spinType   = '15N'
		shift      = NTdict( average = 121.95, sd = 7.6 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'H_AMI'
		spinType   = '1H'
		shift      = NTdict( average = 8.22, sd = 0.67 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 55.63, sd = 2.21 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = NTdict( average = 4.32, sd = 0.49 )
		hetatm     = False
		properties = ['isProton', 'proton', 'isNotCarbon', 'notcarbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isBackbone', 'backbone', 'isNotAromatic', 'notaromatic', 'isNotMethyl', 'notmethyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasNoPseudoAtom', 'hasnopseudoatom', 'isNotMethylene', 'notmethylene', 'isNotMethyleneProton', 'notmethyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 42.32, sd = 2.44 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = NTdict( average = 1.64, sd = 0.4 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = NTdict( average = 1.55, sd = 0.4 )
		hetatm     = False
		properties = ['isProton', 'proton', 'isNotCarbon', 'notcarbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isSidechain', 'sidechain', 'isNotAromatic', 'notaromatic', 'isNotMethyl', 'notmethyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasPseudoAtom', 'haspseudoatom', 'isMethylene', 'methylene', 'isMethyleneProton', 'methyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = NTdict( average = 1.595, sd = 0.4 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 26.8, sd = 2.46 )
		hetatm     = False
		properties = ['isNotProton', 'notproton', 'isCarbon', 'carbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isSidechain', 'sidechain', 'isNotAromatic', 'notaromatic', 'isNotMethyl', 'notmethyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasNoPseudoAtom', 'hasnopseudoatom', 'isNotMethylene', 'notmethylene', 'isNotMethyleneProton', 'notmethyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'STAP': 'HG', 'IUPAC': 'HG', 'CYANA': 'HG', 'PDB': 'HG', 'XPLOR': 'HG', 'CCPN': 'HG', 'BMRBd': 'HG', 'AQUA': 'HG', 'INTERNAL_0': 'HG', 'INTERNAL_1': 'HG', 'CYANA2': 'HG'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = ['HD11', 'HD12', 'HD13']
		pseudo     = 'QD'
		nameDict   = {'STAP': None, 'IUPAC': 'MD1', 'CYANA': 'QD1', 'PDB': None, 'XPLOR': 'HD1*,HD1#,HD1%,HD1+', 'CCPN': 'HD1*', 'BMRBd': 'HD1', 'AQUA': 'MD1', 'INTERNAL_0': 'QD1', 'INTERNAL_1': 'MD1', 'CYANA2': 'QD1'}
		aliases    = ['MD1', 'QD1']
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = NTdict( average = 0.76, sd = 0.38 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		real       = ['HD21', 'HD22', 'HD23']
		pseudo     = 'QD'
		nameDict   = {'STAP': None, 'IUPAC': 'MD2', 'CYANA': 'QD2', 'PDB': None, 'XPLOR': 'HD2*,HD2#,HD2%,HD2+', 'CCPN': 'HD2*', 'BMRBd': 'HD2', 'AQUA': 'MD2', 'INTERNAL_0': 'QD2', 'INTERNAL_1': 'MD2', 'CYANA2': 'QD2'}
		aliases    = ['MD2', 'QD2']
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = NTdict( average = 0.73, sd = 0.4 )
		hetatm     = False
		properties = ['isProton', 'proton', 'isNotCarbon', 'notcarbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isSidechain', 'sidechain', 'isNotAromatic', 'notaromatic', 'isMethyl', 'methyl', 'isMethylProton', 'methylproton', 'isPseudoAtom', 'pseudoatom', 'hasNoPseudoAtom', 'hasnopseudoatom', 'hasPseudoAtom', 'haspseudoatom', 'isNotMethylene', 'notmethylene', 'isNotMethyleneProton', 'notmethyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 24.71, sd = 2.86 )
		hetatm     = False
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MD1'
		nameDict   = {'STAP': 'HD11', 'IUPAC': 'HD11', 'CYANA': 'HD11', 'PDB': '1HD1', 'XPLOR': 'HD11', 'CCPN': 'HD11', 'BMRBd': None, 'AQUA': 'HD11', 'INTERNAL_0': 'HD11', 'INTERNAL_1': 'HD11', 'CYANA2': 'HD11'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MD1'
		nameDict   = {'STAP': 'HD12', 'IUPAC': 'HD12', 'CYANA': 'HD12', 'PDB': '2HD1', 'XPLOR': 'HD12', 'CCPN': 'HD12', 'BMRBd': None, 'AQUA': 'HD12', 'INTERNAL_0': 'HD12', 'INTERNAL_1': 'HD12', 'CYANA2': 'HD12'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MD1'
		nameDict   = {'STAP': 'HD13', 'IUPAC': 'HD13', 'CYANA': 'HD13', 'PDB': '3HD1', 'XPLOR': 'HD13', 'CCPN': 'HD13', 'BMRBd': None, 'AQUA': 'HD13', 'INTERNAL_0': 'HD13', 'INTERNAL_1': 'HD13', 'CYANA2': 'HD13'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 24.22, sd = 2.87 )
		hetatm     = False
		properties = ['isNotProton', 'notproton', 'isCarbon', 'carbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isSidechain', 'sidechain', 'isNotAromatic', 'notaromatic', 'isMethyl', 'methyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasNoPseudoAtom', 'hasnopseudoatom', 'isNotMethylene', 'notmethylene', 'isNotMethyleneProton', 'notmethyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MD2'
		nameDict   = {'STAP': 'HD21', 'IUPAC': 'HD21', 'CYANA': 'HD21', 'PDB': '1HD2', 'XPLOR': 'HD21', 'CCPN': 'HD21', 'BMRBd': None, 'AQUA': 'HD21', 'INTERNAL_0': 'HD21', 'INTERNAL_1': 'HD21', 'CYANA2': 'HD21'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MD2'
		nameDict   = {'STAP': 'HD22', 'IUPAC': 'HD22', 'CYANA': 'HD22', 'PDB': '2HD2', 'XPLOR': 'HD22', 'CCPN': 'HD22', 'BMRBd': None, 'AQUA': 'HD22', 'INTERNAL_0': 'HD22', 'INTERNAL_1': 'HD22', 'CYANA2': 'HD22'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'MD2'
		nameDict   = {'STAP': 'HD23', 'IUPAC': 'HD23', 'CYANA': 'HD23', 'PDB': '3HD2', 'XPLOR': 'HD23', 'CCPN': 'HD23', 'BMRBd': None, 'AQUA': 'HD23', 'INTERNAL_0': 'HD23', 'INTERNAL_1': 'HD23', 'CYANA2': 'HD23'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
		shift      = None
	...
	#---------------------------------------------------------------
		...
		pseudo     = None
		nameDict   = {'STAP': None, 'IUPAC': 'QD', 'CYANA': 'QQD', 'PDB': None, 'XPLOR': 'HD*,HD#', 'CCPN': 'HD*', 'BMRBd': None, 'AQUA': 'QD', 'INTERNAL_0': 'QQD', 'INTERNAL_1': 'QD', 'CYANA2': 'QQD'}
		aliases    = ['QD', 'QQD']
		type       = 'PSEUD'
		spinType   = '1H'
		shift      = NTdict( average = 0.745, sd = 0.39 )
		hetatm     = False
