...
#=======================================================================
	...
	shortName  = 'P'
	comment    = 'cis Proline'
	nameDict   = {'INTERNAL_0': 'cPRO', 'BMRBd': 'PRO', 'CYANA': 'cPRO', 'STAP': 'PRO', 'CYANA2': 'cPRO', 'INTERNAL_1': 'cPRO', 'IUPAC': 'PRO', 'AQUA': 'PRO', 'PDB': 'PRO', 'XPLOR': 'PRO'}
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'INTERNAL_0': 'CD', 'BMRBd': 'CD', 'CYANA': 'CD', 'STAP': 'CD', 'CYANA2': 'CD', 'INTERNAL_1': 'CD', 'IUPAC': 'CD', 'AQUA': 'CD', 'PDB': 'CD', 'XPLOR': 'CD'}
		aliases    = []
		type       = 'C_ALI'
		spinType   = '13C'
	...
	#---------------------------------------------------------------
		...
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 34.16, sd = 1.15 )
		hetatm     = False
		properties = ['isNotProton', 'notproton', 'isCarbon', 'carbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isSidechain', 'sidechain', 'isNotAromatic', 'notaromatic', 'isNotMethyl', 'notmethyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasNoPseudoAtom', 'hasnopseudoatom', 'isMethylene', 'methylene', 'isNotMethyleneProton', 'notmethyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'INTERNAL_0': 'CG', 'BMRBd': 'CG', 'CYANA': 'CG', 'STAP': 'CG', 'CYANA2': 'CG', 'INTERNAL_1': 'CG', 'IUPAC': 'CG', 'AQUA': 'CG', 'PDB': 'CG', 'XPLOR': 'CG'}
		aliases    = []
		type       = 'C_ALI'
		spinType   = '13C'
		shift      = NTdict( average = 24.52, sd = 1.09 )
		hetatm     = False
		properties = ['isNotProton', 'notproton', 'isCarbon', 'carbon', 'isNotNitrogen', 'notnitrogen', 'isNotSulfur', 'isNotSulphur', 'notsulfur', 'notsulphur', 'isSidechain', 'sidechain', 'isNotAromatic', 'notaromatic', 'isNotMethyl', 'notmethyl', 'isNotMethylProton', 'notmethylproton', 'isNotPseudoAtom', 'notpseudoatom', 'hasNoPseudoAtom', 'hasnopseudoatom', 'isMethylene', 'methylene', 'isNotMethyleneProton', 'notmethyleneproton']
	</AtomDef>
	#---------------------------------------------------------------
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QG'
		nameDict   = {'INTERNAL_0': 'HG2', 'BMRBd': 'HG2', 'CYANA': 'HG2', 'STAP': 'HG2', 'CYANA2': 'HG2', 'INTERNAL_1': 'HG2', 'IUPAC': 'HG2', 'AQUA': 'HG2', 'PDB': '1HG', 'XPLOR': 'HG2'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QG'
		nameDict   = {'INTERNAL_0': 'HG3', 'BMRBd': 'HG3', 'CYANA': 'HG3', 'STAP': 'HG1', 'CYANA2': 'HG3', 'INTERNAL_1': 'HG3', 'IUPAC': 'HG3', 'AQUA': 'HG3', 'PDB': '2HG', 'XPLOR': 'HG1'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = ['HG2', 'HG3']
		pseudo     = None
		nameDict   = {'INTERNAL_0': 'QG', 'BMRBd': None, 'CYANA': 'QG', 'STAP': None, 'CYANA2': 'QG', 'INTERNAL_1': 'QG', 'IUPAC': 'QG', 'AQUA': 'QG', 'PDB': None, 'XPLOR': 'HG*,HG#,HG%,HG+'}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QD'
		nameDict   = {'INTERNAL_0': 'HD2', 'BMRBd': 'HD2', 'CYANA': 'HD2', 'STAP': 'HD2', 'CYANA2': 'HD2', 'INTERNAL_1': 'HD2', 'IUPAC': 'HD2', 'AQUA': 'HD2', 'PDB': '1HD', 'XPLOR': 'HD2'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = 'QD'
		nameDict   = {'INTERNAL_0': 'HD3', 'BMRBd': 'HD3', 'CYANA': 'HD3', 'STAP': 'HD1', 'CYANA2': 'HD3', 'INTERNAL_1': 'HD3', 'IUPAC': 'HD3', 'AQUA': 'HD3', 'PDB': '2HD', 'XPLOR': 'HD1'}
		aliases    = []
		type       = 'H_ALI'
		spinType   = '1H'
	...
	#---------------------------------------------------------------
		...
		real       = ['HD2', 'HD3']
		pseudo     = None
		nameDict   = {'INTERNAL_0': 'QD', 'BMRBd': None, 'CYANA': 'QD', 'STAP': None, 'CYANA2': 'QD', 'INTERNAL_1': 'QD', 'IUPAC': 'QD', 'AQUA': 'QD', 'PDB': None, 'XPLOR': 'HD*,HD#,HD%,HD+'}
		aliases    = []
		type       = 'PSEUD'
		spinType   = '1H'
