...
#=======================================================================
	...
	nameDict   = {'STAP': None, 'IUPAC': 'ARG', 'CYANA': 'ARG', 'PDB': None, 'XPLOR': 'ARG', 'CCPN': 'protein Arg deprot:HH12', 'BMRBd': None, 'AQUA': 'ARG', 'INTERNAL_0': 'ARGx', 'INTERNAL_1': 'ARGx', 'CYANA2': None}
	...
	#---------------------------------------------------------------
		...
		real       = []
		pseudo     = None
		nameDict   = {'STAP': 'HH1', 'IUPAC': 'HH1', 'CYANA': 'HH1', 'PDB': 'HH1', 'XPLOR': 'HH1', 'CCPN': 'HH11', 'BMRBd': 'HH1', 'AQUA': 'HH1', 'INTERNAL_0': 'HH1', 'INTERNAL_1': 'HH1', 'CYANA2': 'HH1'}
		aliases    = []
		type       = 'H_AMI'
		spinType   = '1H'
