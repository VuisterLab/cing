...
#=======================================================================
#             	internal short   
<ResidueDef>  	THY      t        INTERNAL_0
#=======================================================================
	comment    = 'deoxy-thymine'
	nameDict   = {'CCPN': 'DNA T prot:H3', 'INTERNAL_0': 'THY', 'IUPAC': 'DT', 'AQUA': 'T', 'BMRBd': 'THY', 'INTERNAL_1': 'DT', 'CYANA': 'THY', 'CYANA2': 'THY', 'PDB': 'THY', 'XPLOR': 'THY'}
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'C7', 'INTERNAL_0': 'C7', 'IUPAC': 'C7', 'AQUA': 'C7', 'BMRBd': None, 'INTERNAL_1': 'C7', 'CYANA': 'C7', 'CYANA2': 'C7', 'PDB': None, 'XPLOR': 'C7'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'C_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'C7')]
		nameDict   = {'CCPN': 'H71', 'INTERNAL_0': 'H71', 'IUPAC': 'H71', 'AQUA': 'H71', 'BMRBd': None, 'INTERNAL_1': 'H71', 'CYANA': 'H71', 'CYANA2': 'H71', 'PDB': None, 'XPLOR': 'H71'}
		aliases    = []
		pseudo     = 'Q7'
		real       = []
		type       = 'H_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'C7')]
		nameDict   = {'CCPN': 'H72', 'INTERNAL_0': 'H72', 'IUPAC': 'H72', 'AQUA': 'H72', 'BMRBd': None, 'INTERNAL_1': 'H72', 'CYANA': 'H72', 'CYANA2': 'H72', 'PDB': None, 'XPLOR': 'H72'}
		aliases    = []
		pseudo     = 'Q7'
		real       = []
		type       = 'H_ALI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'C7')]
		nameDict   = {'CCPN': 'H73', 'INTERNAL_0': 'H73', 'IUPAC': 'H73', 'AQUA': 'H73', 'BMRBd': None, 'INTERNAL_1': 'H73', 'CYANA': 'H73', 'CYANA2': 'H73', 'PDB': None, 'XPLOR': 'H73'}
		aliases    = []
		pseudo     = 'Q7'
		real       = []
		type       = 'H_ALI'
	...
	#---------------------------------------------------------------
		topology   = []
		nameDict   = {'CCPN': 'H7*', 'INTERNAL_0': 'Q7', 'IUPAC': 'M7', 'AQUA': 'M7', 'BMRBd': None, 'INTERNAL_1': 'M7', 'CYANA': 'Q7', 'CYANA2': 'Q7', 'PDB': None, 'XPLOR': 'Q7'}
		aliases    = ['M7', 'Q7']
		pseudo     = None
		real       = ['H71', 'H72', 'H73']
		type       = 'PSEUD'
