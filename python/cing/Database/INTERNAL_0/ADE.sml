...
#=======================================================================
#             	internal short   
<ResidueDef>  	ADE      da       INTERNAL_0
#=======================================================================
	comment    = 'deoxy-adenine'
	nameDict   = {'CCPN': 'DNA A deprot:H1', 'INTERNAL_0': 'ADE', 'IUPAC': 'DA', 'AQUA': 'A', 'BMRBd': 'ADE', 'INTERNAL_1': 'DA', 'CYANA': 'ADE', 'CYANA2': 'ADE', 'PDB': 'ADE', 'XPLOR': 'ADE'}
	...
	#---------------------------------------------------------------
		...
		nameDict   = {'CCPN': 'N6', 'INTERNAL_0': 'N6', 'IUPAC': 'N6', 'AQUA': 'N6', 'BMRBd': None, 'INTERNAL_1': 'N6', 'CYANA': 'N6', 'CYANA2': 'N6', 'PDB': None, 'XPLOR': 'N6'}
		aliases    = []
		pseudo     = None
		real       = []
		type       = 'N_AMI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'N6')]
		nameDict   = {'CCPN': 'H61', 'INTERNAL_0': 'H61', 'IUPAC': 'H61', 'AQUA': 'H61', 'BMRBd': None, 'INTERNAL_1': 'H61', 'CYANA': 'H61', 'CYANA2': 'H61', 'PDB': None, 'XPLOR': 'H61'}
		aliases    = []
		pseudo     = 'Q6'
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		topology   = [(0, 'N6')]
		nameDict   = {'CCPN': 'H62', 'INTERNAL_0': 'H62', 'IUPAC': 'H62', 'AQUA': 'H62', 'BMRBd': None, 'INTERNAL_1': 'H62', 'CYANA': 'H62', 'CYANA2': 'H62', 'PDB': None, 'XPLOR': 'H62'}
		aliases    = []
		pseudo     = 'Q6'
		real       = []
		type       = 'H_AMI'
	...
	#---------------------------------------------------------------
		topology   = []
		nameDict   = {'CCPN': 'H6*', 'INTERNAL_0': 'Q6', 'IUPAC': 'Q6', 'AQUA': 'Q6', 'BMRBd': None, 'INTERNAL_1': 'Q6', 'CYANA': 'Q6', 'CYANA2': 'Q6', 'PDB': None, 'XPLOR': 'Q6'}
		aliases    = []
		pseudo     = None
		real       = ['H61', 'H62']
		type       = 'PSEUD'
